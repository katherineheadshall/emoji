...
$parcel$export(module.exports, "Picker", function () { return $043e38d44d29f17c$export$2e2bcd8739ae039; });
$parcel$export(module.exports, "Emoji", function () { return $3232a436e624d824$export$2e2bcd8739ae039; });
$parcel$export(module.exports, "SearchIndex", function () { return $53b84a3588a4ed26$export$2e2bcd8739ae039; });
$parcel$export(module.exports, "FrequentlyUsed", function () { return $ab5af1839056a450$export$2e2bcd8739ae039; });
$parcel$export(module.exports, "init", function () { return $29f1390e7c18265e$export$2cd8252107eb640b; });
$parcel$export(module.exports, "Data", function () { return $29f1390e7c18265e$export$2d0294657ab35f1b; });
$parcel$export(module.exports, "I18n", function () { return $29f1390e7c18265e$export$dbe3113d60765c1a; });
$parcel$export(module.exports, "getEmojiDataFromNative", function () { return $8ce90054fce3d34f$export$5ef5574deca44bc0; });
...
function $f0029f8cef40744a$var$set(key, value) {
    try {
        window.localStorage[`emoji-mart.${key}`] = JSON.stringify(value);
    } catch (error) {
    }
}
function $f0029f8cef40744a$var$get(key) {
    try {
...
var $f0029f8cef40744a$export$2e2bcd8739ae039 = {
    set: $f0029f8cef40744a$var$set,
    get: $f0029f8cef40744a$var$get
};


const $11ba271887ecc061$var$CACHE = new Map();
const $11ba271887ecc061$var$VERSIONS = [
    {
        v: 14,
        emoji: '🫠'
    },
...
function $11ba271887ecc061$var$latestVersion() {
    for (const { v: v , emoji: emoji  } of $11ba271887ecc061$var$VERSIONS){
        if ($11ba271887ecc061$var$isSupported(emoji)) return v;
    }
}
function $11ba271887ecc061$var$noCountryFlags() {
    if ($11ba271887ecc061$var$isSupported('🇨🇦')) return false;
    return true;
}
function $11ba271887ecc061$var$isSupported(emoji) {
    if ($11ba271887ecc061$var$CACHE.has(emoji)) return $11ba271887ecc061$var$CACHE.get(emoji);
    const supported = $11ba271887ecc061$var$isEmojiSupported(emoji);
    $11ba271887ecc061$var$CACHE.set(emoji, supported);
    return supported;
}
// https://github.com/koala-interactive/is-emoji-supported
const $11ba271887ecc061$var$isEmojiSupported = (()=>{
    let ctx = null;
    try {
...
var $11ba271887ecc061$export$2e2bcd8739ae039 = {
    latestVersion: $11ba271887ecc061$var$latestVersion,
    noCountryFlags: $11ba271887ecc061$var$noCountryFlags
};



const $ab5af1839056a450$var$DEFAULTS = [
    '+1',
    'grinning',
    'kissing_heart',
    'heart_eyes',
...
let $ab5af1839056a450$var$Index = null;
function $ab5af1839056a450$var$add(emoji) {
    $ab5af1839056a450$var$Index || ($ab5af1839056a450$var$Index = $f0029f8cef40744a$export$2e2bcd8739ae039.get('frequently') || {
    });
    const emojiId = emoji.id || emoji;
    if (!emojiId) return;
    $ab5af1839056a450$var$Index[emojiId] || ($ab5af1839056a450$var$Index[emojiId] = 0);
    $ab5af1839056a450$var$Index[emojiId] += 1;
    $f0029f8cef40744a$export$2e2bcd8739ae039.set('last', emojiId);
    $f0029f8cef40744a$export$2e2bcd8739ae039.set('frequently', $ab5af1839056a450$var$Index);
}
function $ab5af1839056a450$var$get({ maxFrequentRows: maxFrequentRows , perLine: perLine  }) {
    if (!maxFrequentRows) return [];
    $ab5af1839056a450$var$Index || ($ab5af1839056a450$var$Index = $f0029f8cef40744a$export$2e2bcd8739ae039.get('frequently'));
    let emojiIds = [];
    if (!$ab5af1839056a450$var$Index) {
        $ab5af1839056a450$var$Index = {
        };
        for(let i in $ab5af1839056a450$var$DEFAULTS.slice(0, perLine)){
            const emojiId = $ab5af1839056a450$var$DEFAULTS[i];
            $ab5af1839056a450$var$Index[emojiId] = perLine - i;
            emojiIds.push(emojiId);
        }
        return emojiIds;
    }
    const max = maxFrequentRows * perLine;
    const last = $f0029f8cef40744a$export$2e2bcd8739ae039.get('last');
    for(let emojiId in $ab5af1839056a450$var$Index)emojiIds.push(emojiId);
    emojiIds.sort((a, b)=>{
        const aScore = $ab5af1839056a450$var$Index[b];
        const bScore = $ab5af1839056a450$var$Index[a];
    ...
    if (emojiIds.length > max) {
        ...
        for (let removedId of removedIds){
            ...
            delete $ab5af1839056a450$var$Index[removedId];
        }
        if (last && emojiIds.indexOf(last) == -1) {
            delete $ab5af1839056a450$var$Index[emojiIds[emojiIds.length - 1]];
...
var $ab5af1839056a450$export$2e2bcd8739ae039 = {
    add: $ab5af1839056a450$var$add,
    get: $ab5af1839056a450$var$get
};


var $28d80d9fcfa3732f$exports = {};
$28d80d9fcfa3732f$exports = JSON.parse("{\"search\":\"Procurar\",\"search_no_results_1\":\"Ah não!\",\"search_no_results_2\":\"Esse emoji não foi encontrado\",\"pick\":\"Escolha um emoji...\",\"add_custom\":\"Adicione um emoji customizado\",\"categories\":{\"activity\":\"Atividade\",\"custom\":\"Customizado\",\"flags\":\"Bandeiras\",\"foods\":\"Comidas & Bebidas\",\"frequent\":\"Usados recentemente\",\"nature\":\"Animais & Natureza\",\"objects\":\"Objetos\",\"people\":\"Carinhas & Pessoas\",\"places\":\"Viagens & Lugares\",\"search\":\"Resultados encontrados\",\"symbols\":\"Símbolos\"},\"skins\":{\"1\":\"Selecionar\",\"2\":\"Selecionar\",\"3\":\"Selecionar\",\"4\":\"Selecionar\",\"5\":\"Selecionar\",\"6\":\"Selecionar\",\"choose\":\"Personalizar\"}}");


var $184a3a1596ed3555$export$2e2bcd8739ae039 = {
    autoFocus: {
        value: false
    },
    emojiButtonColors: {
...
let $29f1390e7c18265e$export$dbe3113d60765c1a = null;
let $29f1390e7c18265e$export$2d0294657ab35f1b = null;
const $29f1390e7c18265e$var$fetchCache = {
};
async function $29f1390e7c18265e$var$fetchJSON(src) {
    if ($29f1390e7c18265e$var$fetchCache[src]) return $29f1390e7c18265e$var$fetchCache[src];
    const response = await fetch(src);
    const json = await response.json();
    $29f1390e7c18265e$var$fetchCache[src] = json;
    return json;
}
let $29f1390e7c18265e$var$promise = null;
let $29f1390e7c18265e$var$initCallback = null;
let $29f1390e7c18265e$var$initialized = false;
function $29f1390e7c18265e$export$2cd8252107eb640b(options, { caller: caller  } = {
}) {
    $29f1390e7c18265e$var$promise || ($29f1390e7c18265e$var$promise = new Promise((resolve)=>{
        $29f1390e7c18265e$var$initCallback = resolve;
    }));
    if (options) $29f1390e7c18265e$var$_init(options);
    else if (caller && !$29f1390e7c18265e$var$initialized) console.warn(`\`${caller}\` requires data to be initialized first. Promise will be pending until \`init\` is called.`);
    return $29f1390e7c18265e$var$promise;
}
async function $29f1390e7c18265e$var$_init(props) {
    $29f1390e7c18265e$var$initialized = true;
    let { emojiVersion: emojiVersion , set: set , locale: locale  } = props;
    emojiVersion || (emojiVersion = $184a3a1596ed3555$export$2e2bcd8739ae039.emojiVersion.value);
    set || (set = $184a3a1596ed3555$export$2e2bcd8739ae039.set.value);
    locale || (locale = $184a3a1596ed3555$export$2e2bcd8739ae039.locale.value);
    if (!$29f1390e7c18265e$export$2d0294657ab35f1b) {
        $29f1390e7c18265e$export$2d0294657ab35f1b = (typeof props.data === 'function' ? await props.data() : props.data) || await $29f1390e7c18265e$var$fetchJSON(`https://cdn.jsdelivr.net/npm/@emoji-mart/data@latest/sets/${emojiVersion}/${set}.json`);
        $29f1390e7c18265e$export$2d0294657ab35f1b.emoticons = {
        };
        $29f1390e7c18265e$export$2d0294657ab35f1b.natives = {
        };
        $29f1390e7c18265e$export$2d0294657ab35f1b.categories.unshift({
            id: 'frequent',
            emojis: []
        });
        for(const alias in $29f1390e7c18265e$export$2d0294657ab35f1b.aliases){
            const emojiId = $29f1390e7c18265e$export$2d0294657ab35f1b.aliases[alias];
            const emoji = $29f1390e7c18265e$export$2d0294657ab35f1b.emojis[emojiId];
            if (!emoji) continue;
            emoji.aliases || (emoji.aliases = []);
            emoji.aliases.push(alias);
        }
    } else $29f1390e7c18265e$export$2d0294657ab35f1b.categories = $29f1390e7c18265e$export$2d0294657ab35f1b.categories.filter((c)=>{
        const isCustom = !!c.name;
        if (!isCustom) return true;
        return false;
    });
    $29f1390e7c18265e$export$dbe3113d60765c1a = (typeof props.i18n === 'function' ? await props.i18n() : props.i18n) || (locale == 'en' ? (/*@__PURE__*/$parcel$interopDefault($28d80d9fcfa3732f$exports)) : await $29f1390e7c18265e$var$fetchJSON(`https://cdn.jsdelivr.net/npm/@emoji-mart/data@latest/i18n/${locale}.json`));
    if (props.custom) for(let i in props.custom){
        ...
        category.name || (category.name = $29f1390e7c18265e$export$dbe3113d60765c1a.categories.custom);
        if (prevCategory && !category.icon) category.target = prevCategory.target || prevCategory;
        $29f1390e7c18265e$export$2d0294657ab35f1b.categories.push(category);
        for (const emoji of category.emojis)$29f1390e7c18265e$export$2d0294657ab35f1b.emojis[emoji.id] = emoji;
    }
    if (props.categories) $29f1390e7c18265e$export$2d0294657ab35f1b.categories = $29f1390e7c18265e$export$2d0294657ab35f1b.categories.filter((c)=>{
    ...
    if (set == 'native') {
        latestVersionSupport = $11ba271887ecc061$export$2e2bcd8739ae039.latestVersion();
        noCountryFlags = props.noCountryFlags || $11ba271887ecc061$export$2e2bcd8739ae039.noCountryFlags();
    }
    let categoryIndex = $29f1390e7c18265e$export$2d0294657ab35f1b.categories.length;
    let resetSearchIndex = false;
    while(categoryIndex--){
        const category = $29f1390e7c18265e$export$2d0294657ab35f1b.categories[categoryIndex];
        if (category.id == 'frequent') {
            let { maxFrequentRows: maxFrequentRows , perLine: perLine  } = props;
            maxFrequentRows || (maxFrequentRows = $184a3a1596ed3555$export$2e2bcd8739ae039.maxFrequentRows.value);
            perLine || (perLine = $184a3a1596ed3555$export$2e2bcd8739ae039.perLine.value);
            category.emojis = $ab5af1839056a450$export$2e2bcd8739ae039.get({
                maxFrequentRows: maxFrequentRows,
                perLine: perLine
            });
        }
        if (!category.emojis || !category.emojis.length) {
            $29f1390e7c18265e$export$2d0294657ab35f1b.categories.splice(categoryIndex, 1);
            continue;
        }
        ...
        while(emojiIndex--){
            ...
            const emoji = emojiId.id ? emojiId : $29f1390e7c18265e$export$2d0294657ab35f1b.emojis[emojiId];
            const ignore = ()=>{
            ...
            if (noCountryFlags && category.id == 'flags') {
                if (!$059df152bde53567$export$bcb25aa587e9cb13.includes(emoji.id)) {
                    ignore();
                    continue;
                }
            }
            if (!emoji.search) {
                ...
                if (emoji.emoticons) for (const emoticon of emoji.emoticons){
                    if ($29f1390e7c18265e$export$2d0294657ab35f1b.emoticons[emoticon]) continue;
                    $29f1390e7c18265e$export$2d0294657ab35f1b.emoticons[emoticon] = emoji.id;
                }
                let skinIndex = 0;
                for (const skin of emoji.skins){
                    ...
                    if (native) {
                        $29f1390e7c18265e$export$2d0294657ab35f1b.natives[native] = emoji.id;
                        emoji.search += `,${native}`;
                    }
    ...
    if (resetSearchIndex) $53b84a3588a4ed26$export$2e2bcd8739ae039.reset();
    $29f1390e7c18265e$var$initCallback();
}
function $29f1390e7c18265e$export$75fe5f91d452f94b(props, defaultProps, element) {
    props || (props = {
    });
    const _props = {
    };
    for(let k in defaultProps)_props[k] = $29f1390e7c18265e$export$88c9ddb45cea7241(k, props, defaultProps, element);
    return _props;
}
function $29f1390e7c18265e$export$88c9ddb45cea7241(propName, props, defaultProps, element) {
...
const $53b84a3588a4ed26$var$SHORTCODES_REGEX = /^(?:\:([^\:]+)\:)(?:\:skin-tone-(\d)\:)?$/;
let $53b84a3588a4ed26$var$Pool = null;
function $53b84a3588a4ed26$var$get(emojiId) {
    if (emojiId.id) return emojiId;
    return $29f1390e7c18265e$export$2d0294657ab35f1b.emojis[emojiId] || $29f1390e7c18265e$export$2d0294657ab35f1b.emojis[$29f1390e7c18265e$export$2d0294657ab35f1b.aliases[emojiId]] || $29f1390e7c18265e$export$2d0294657ab35f1b.emojis[$29f1390e7c18265e$export$2d0294657ab35f1b.natives[emojiId]];
}
function $53b84a3588a4ed26$var$reset() {
    $53b84a3588a4ed26$var$Pool = null;
}
async function $53b84a3588a4ed26$var$search(value, { maxResults: maxResults , caller: caller  } = {
}) {
    if (!value || !value.trim().length) return null;
    maxResults || (maxResults = 90);
    await $29f1390e7c18265e$export$2cd8252107eb640b(null, {
    ...
    let pool = $53b84a3588a4ed26$var$Pool || ($53b84a3588a4ed26$var$Pool = Object.values($29f1390e7c18265e$export$2d0294657ab35f1b.emojis));
    let results, scores;
...
var $53b84a3588a4ed26$export$2e2bcd8739ae039 = {
    search: $53b84a3588a4ed26$var$search,
    get: $53b84a3588a4ed26$var$get,
    reset: $53b84a3588a4ed26$var$reset,
    SHORTCODES_REGEX: $53b84a3588a4ed26$var$SHORTCODES_REGEX
};


const $059df152bde53567$export$bcb25aa587e9cb13 = [
    'checkered_flag',
    'crossed_flags',
    'pirate_flag',
    'rainbow-flag',
...
function $8ce90054fce3d34f$export$9cb4719e2e525b7a(a, b) {
    return Array.isArray(a) && Array.isArray(b) && a.length === b.length && a.every((val, index)=>val == b[index]
    );
}
async function $8ce90054fce3d34f$export$e772c8ff12451969(frames = 1) {
    for(let _ in [
        ...Array(frames).keys()
    ])await new Promise(requestAnimationFrame);
}
function $8ce90054fce3d34f$export$d10ac59fbe52a745(emoji, { skinIndex: skinIndex  } = {
}) {
...
async function $8ce90054fce3d34f$export$5ef5574deca44bc0(nativeString) {
    const results = await $53b84a3588a4ed26$export$2e2bcd8739ae039.search(nativeString, {
        maxResults: 1,
    ...
    return $8ce90054fce3d34f$export$d10ac59fbe52a745(emoji, {
        skinIndex: skinIndex
    });
}
...
const $548a3e023f033872$var$categories = {
    activity: {
...
const $548a3e023f033872$var$search = {
...
var $548a3e023f033872$export$2e2bcd8739ae039 = {
    categories: $548a3e023f033872$var$categories,
    search: $548a3e023f033872$var$search
};
...
function $dc05dda8c82c9665$export$2e2bcd8739ae039(props) {
    let { id: id , skin: skin , emoji: emoji  } = props;
    if (props.shortcodes) {
        const matches = props.shortcodes.match($53b84a3588a4ed26$export$2e2bcd8739ae039.SHORTCODES_REGEX);
        if (matches) {
            id = matches[1];
            if (matches[2]) skin = matches[2];
        }
    }
    emoji || (emoji = $53b84a3588a4ed26$export$2e2bcd8739ae039.get(id || props.native));
    ...
    return(/*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b("span", {
        ...
        children: imageSrc ? /*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b("img", {
            ...
            style: {
                ...
                backgroundSize: `${100 * $29f1390e7c18265e$export$2d0294657ab35f1b.sheet.cols}% ${100 * $29f1390e7c18265e$export$2d0294657ab35f1b.sheet.rows}%`,
                backgroundPosition: `${100 / ($29f1390e7c18265e$export$2d0294657ab35f1b.sheet.cols - 1) * emojiSkin.x}% ${100 / ($29f1390e7c18265e$export$2d0294657ab35f1b.sheet.rows - 1) * emojiSkin.y}%`
            }
        })
    }));
}
...
const $80307a2badd8ffb7$var$WindowHTMLElement = typeof window !== 'undefined' ? window.HTMLElement : Object;
class $80307a2badd8ffb7$export$2e2bcd8739ae039 extends $80307a2badd8ffb7$var$WindowHTMLElement {
    ...
    attributeChangedCallback(attr, _, newValue) {
        ...
        const value = $29f1390e7c18265e$export$88c9ddb45cea7241(attr, {
            [attr]: newValue
...
class $b091b7bfc909bdac$export$2e2bcd8739ae039 extends $80307a2badd8ffb7$export$2e2bcd8739ae039 {
    setShadow() {
        this.attachShadow({
            mode: 'open'
        });
...
var $58378ef08fa06de4$export$2e2bcd8739ae039 = {
    fallback: '',
    id: '',
    native: '',
    shortcodes: '',
    ...
    // Shared
    set: $184a3a1596ed3555$export$2e2bcd8739ae039.set,
    skin: $184a3a1596ed3555$export$2e2bcd8739ae039.skin
};


class $3232a436e624d824$export$2e2bcd8739ae039 extends $80307a2badd8ffb7$export$2e2bcd8739ae039 {
    async connectedCallback() {
        const props = $29f1390e7c18265e$export$75fe5f91d452f94b(this.props, $58378ef08fa06de4$export$2e2bcd8739ae039, this);
        props.element = this;
        props.ref = (component)=>{
            this.component = component;
        };
        await $29f1390e7c18265e$export$2cd8252107eb640b();
        $d5fc6ac583bc94a1$export$b3890eb0ae9dca99(/*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b($dc05dda8c82c9665$export$2e2bcd8739ae039, {
            ...props
        }), this);
    }
    constructor(props){
...
$1459522e281add88$export$2e2bcd8739ae039($3232a436e624d824$export$2e2bcd8739ae039, "Props", $58378ef08fa06de4$export$2e2bcd8739ae039);
if (typeof customElements !== 'undefined' && !customElements.get('em-emoji')) customElements.define('em-emoji', $3232a436e624d824$export$2e2bcd8739ae039);
...
const $4d89cc185d8b033b$var$THEME_ICONS = {
    light: 'outline',
    dark: 'solid'
};
class $4d89cc185d8b033b$export$2e2bcd8739ae039 extends $d7e5aa0d2b8fa1f1$export$221d75b3f55bb0bd {
    renderIcon(category) {
        ...
        const categoryIcons = $548a3e023f033872$export$2e2bcd8739ae039.categories[category.id] || $548a3e023f033872$export$2e2bcd8739ae039.categories.custom;
        const style = this.props.icons == 'auto' ? $4d89cc185d8b033b$var$THEME_ICONS[this.props.theme] : this.props.icons;
            ...
            children: /*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b("div", {
                ...
                children: [
                    this.categories.map((category, i)=>{
                        const title = category.name || $29f1390e7c18265e$export$dbe3113d60765c1a.categories[category.id];
    ...
    constructor(){
        super();
        this.categories = $29f1390e7c18265e$export$2d0294657ab35f1b.categories.filter((category)=>{
...
class $8d3ac3bcb43c43b1$export$2e2bcd8739ae039 extends $d7e5aa0d2b8fa1f1$export$221d75b3f55bb0bd {
...
const $d2cc3511de54c83f$var$Performance = {
    rowsPerRender: 10
};
class $d2cc3511de54c83f$export$2e2bcd8739ae039 extends $d5fc6ac583bc94a1$export$16fa2f45be04daa8 {
    getInitialState(props = this.props) {
        return {
            skin: $f0029f8cef40744a$export$2e2bcd8739ae039.get('skin') || props.skin,
            theme: this.initTheme(props.theme)
        };
    }
    componentWillMount() {
        this.observers = [];
        this.dir = $29f1390e7c18265e$export$dbe3113d60765c1a.rtl ? 'rtl' : 'ltr';
        this.refs = {
    ...
    async reset(nextState = {
        ...
        await $29f1390e7c18265e$export$2cd8252107eb640b(this.props);
        this.initGrid();
        this.unobserve();
        this.setState(nextState, ()=>{
    ...
    initGrid() {
        const { categories: categories  } = $29f1390e7c18265e$export$2d0294657ab35f1b;
        this.refs.categories = new Map();
        const navKey = $29f1390e7c18265e$export$2d0294657ab35f1b.categories.map((category)=>category.id
        ).join(',');
        ...
        const addRow = (rows, category)=>{
            ...
            const rowRef = rowIndex % $d2cc3511de54c83f$var$Performance.rowsPerRender ? {
    ...
    getEmojiByPos([p1, p2]) {
        ...
        if (!emoji) return;
        return $53b84a3588a4ed26$export$2e2bcd8739ae039.get(emoji);
    }
    observeCategories() {
    ...
    observeRows() {
        ...
        const observer = new IntersectionObserver((entries)=>{
            ...
            root: this.refs.scroll.current,
            rootMargin: `${this.props.emojiButtonSize * ($d2cc3511de54c83f$var$Performance.rowsPerRender + 5)}px 0px ${this.props.emojiButtonSize * $d2cc3511de54c83f$var$Performance.rowsPerRender}px`
        });
    ...
    handleEmojiClick({ emoji: emoji , pos: pos  }) {
        ...
        if (emoji) {
            const emojiData = $8ce90054fce3d34f$export$d10ac59fbe52a745(emoji, {
                skinIndex: this.state.skin - 1
            });
            if (this.props.maxFrequentRows) $ab5af1839056a450$export$2e2bcd8739ae039.add(emojiData, this.props);
    ...
    handleSkinClick(skin) {
        ...
        $f0029f8cef40744a$export$2e2bcd8739ae039.set('skin', skin);
    }
    renderNav() {
        return(/*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b($4d89cc185d8b033b$export$2e2bcd8739ae039, {
                ...
                /*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b("div", {
                    ...
                    children: [
                        /*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b("div", {
                            ...
                            children: /*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b($dc05dda8c82c9665$export$2e2bcd8739ae039, {
                                emoji: emoji,
                            ...
                            children: emoji ? /*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b("div", {
                                        ...
                                        children: $29f1390e7c18265e$export$dbe3113d60765c1a.search_no_results_1
                                    }),
                                    /*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b("div", {
                                        class: "ellipsis color-c",
                                        style: {
                                        ...
                                        children: $29f1390e7c18265e$export$dbe3113d60765c1a.search_no_results_2
                                    })
                                ]
                            }) : /*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b("div", {
                                class: "color-c",
                                ...
                                children: $29f1390e7c18265e$export$dbe3113d60765c1a.pick
                            })
                        })
                    ]
                }),
                !emoji && this.props.skinTonePosition == 'preview' && this.renderSkinToneButton(),
                !emoji && this.props.skinTonePosition == 'preview' && this.renderCloseButton()
            ]
        }));
    }
    renderEmojiButton(emoji, { pos: pos , posinset: posinset , grid: grid  }) {
        ...
        const selected = $8ce90054fce3d34f$export$9cb4719e2e525b7a(this.state.pos, pos);
        const key = pos.concat(emoji.id).join('');
        return(/*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b($8d3ac3bcb43c43b1$export$2e2bcd8739ae039, {
            selected: selected,
            skin: skin,
            size: size,
            children: /*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b("button", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b($dc05dda8c82c9665$export$2e2bcd8739ae039, {
                        emoji: emoji,
                        set: this.props.set,
                        ...
                        /*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b("div", {
                            ...
                            children: [
                                /*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b("input", {
                                    ...
                                    placeholder: $29f1390e7c18265e$export$dbe3113d60765c1a.search,
                                ...
                                /*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b("span", {
                                    ...
                                    children: $548a3e023f033872$export$2e2bcd8739ae039.search.loupe
                                }),
                                this.state.searchResults && /*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b("button", {
                                    ...
                                    children: $548a3e023f033872$export$2e2bcd8739ae039.search.delete
                                })
                            ]
                        }),
        ...
        return(/*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b("div", {
            ...
            children: [
                /*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b("div", {
                    ...
                    children: $29f1390e7c18265e$export$dbe3113d60765c1a.categories.search
                }),
                /*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b("div", {
                    children: !searchResults.length ? /*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b("div", {
                        ...
                        children: this.props.onAddCustomEmoji && /*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b("a", {
                            ...
                            children: $29f1390e7c18265e$export$dbe3113d60765c1a.add_custom
                        })
            ...
            children: categories.map((category)=>{
                ...
                return(/*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b("div", {
                    ...
                    children: [
                        /*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b("div", {
                            class: `sticky padding-small align-${this.dir[0]}`,
                            children: category.name || $29f1390e7c18265e$export$dbe3113d60765c1a.categories[category.id]
                        }),
                        /*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b("div", {
                            class: "relative",
                            style: {
                            ...
                            children: rows.map((row, i)=>{
                                const targetRow = row.index - row.index % $d2cc3511de54c83f$var$Performance.rowsPerRender;
                                ...
                                return(/*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b("div", {
                                    ...
                                    children: visible && emojiIds.map((emojiId, ii)=>{
                                        const emoji = $53b84a3588a4ed26$export$2e2bcd8739ae039.get(emojiId);
                                        return this.renderEmojiButton(emoji, {
                                            pos: [
                                                row.index,
                                                ii
    ...
    renderSkinToneButton() {
        ...
        return(/*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b("div", {
            ...
            children: /*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b("button", {
                ...
                "aria-label": $29f1390e7c18265e$export$dbe3113d60765c1a.skins.choose,
                title: $29f1390e7c18265e$export$dbe3113d60765c1a.skins.choose,
    ...
    renderCloseButton() {
        ...
        return(/*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b("div", {
            ...
            children: /*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b("button", {
                ...
                children: /*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b("span", {
                    class: `skin-tone skin-tone-${this.state.skin} close-button-container`,
                    children: /*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b("div", {
                ...
                return(/*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b("div", {
                    children: [
                        /*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b("input", {
                            ...
                            name: "skin-tone",
                            value: skin,
                            "aria-label": $29f1390e7c18265e$export$dbe3113d60765c1a.skins[skin],
                        ...
                        /*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b("button", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b("span", {
                                    ...
                                    children: $29f1390e7c18265e$export$dbe3113d60765c1a.skins[skin]
                                })
                            ]
                        })
                    ]
    ...
    constructor(props){
        ...
        $1459522e281add88$export$2e2bcd8739ae039(this, "handleSearchInput", async ()=>{
            ...
            const searchResults = await $53b84a3588a4ed26$export$2e2bcd8739ae039.search(value);
            const afterRender = ()=>{
        ...
        $1459522e281add88$export$2e2bcd8739ae039(this, "openSkins", (e)=>{
            ...
            this.setState({
                ...
                await $8ce90054fce3d34f$export$e772c8ff12451969(2);
...
class $043e38d44d29f17c$export$2e2bcd8739ae039 extends $b091b7bfc909bdac$export$2e2bcd8739ae039 {
    async connectedCallback() {
        const props = $29f1390e7c18265e$export$75fe5f91d452f94b(this.props, $184a3a1596ed3555$export$2e2bcd8739ae039, this);
        props.element = this;
        props.ref = (component)=>{
            this.component = component;
        };
        await $29f1390e7c18265e$export$2cd8252107eb640b(props);
        $d5fc6ac583bc94a1$export$b3890eb0ae9dca99(/*#__PURE__*/ $55ec52987511209e$export$34b9dba7ce09269b($d2cc3511de54c83f$export$2e2bcd8739ae039, {
            ...props
        }), this.shadowRoot);
    }
